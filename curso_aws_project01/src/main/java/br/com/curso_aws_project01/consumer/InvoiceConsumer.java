package br.com.curso_aws_project01.consumer;

import br.com.curso_aws_project01.model.Invoice;
import br.com.curso_aws_project01.model.SnsMessage;
...
public class InvoiceConsumer {
    ...
    private void processInvoiceNotification(S3EventNotification s3EventNotification) throws IOException {
        ...
        //TODO rever if
        if (Objects.isNull(s3EventNotification) || Objects.isNull(s3EventNotification.getRecords())) {
            return;
        }
